...
return [
    ...
    */
    ...
    'sms_source' => (string) env('SMS_SOURCE'),
    'sms_two_step_verification' => (bool) env('SMS_TWO_STEP_VERIFACATION'),
    ...
    'mail_two_step_verification' => (string) env('MAIL_TWO_STEP_VERIFACATION'),
